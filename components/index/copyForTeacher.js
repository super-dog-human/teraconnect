          ...
          <FlexItem flexBasis='60%'>
            <Flex justifyContent='center' flexWrap='wrap' gap='50px'>
              <FlexItem flexBasis='320px'>
                <Flex>
                  <img src="/img/yeti.webp" srcSet="/img/yeti.webp 1x, /img/yeti@2x.webp 2x" width="80px" height="80px" alt="雪男でも、岩でも、何にでも" />
                  <Spacer width='30' />
                  <div>
              ...
              <FlexItem flexBasis='320px'>
                <Flex>
                  <img src="/img/microphone.webp" srcSet="/img/microphone.webp 1x, /img/microphone@2x.webp 2x" width="80px" height="80px" alt="マイクを使って声を吹き込もう" />
                  <Spacer width='30' />
                  <div>
              ...
              <FlexItem flexBasis='320px'>
                <Flex>
                  <img src="/img/blackboard.webp" srcSet="/img/blackboard.webp 1x, /img/blackboard@2x.webp 2x" width="80px" height="80px" alt="もっと分かりやすく" />
                  <Spacer width='30' />
                  <div>
              ...
              <FlexItem flexBasis='320px'>
                <Flex>
                  <img src="/img/no-fee.webp" srcSet="/img/no-fee.webp 1x, /img/no-fee@2x.webp 2x" width="80px" height="80px" alt="お金はかからないよ" />
                  <Spacer width='30' />
                  <div>
