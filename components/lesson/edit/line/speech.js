...
export default function LessonLineSpeech({ speech, index, lineIndex, handleEditClick, isEditButtonShow }) {
  const { isLoading, isPlaying, inputRef, status, handleSpeechButtonClick, handleEditButtonClick, handleInputKeyDown, handleInputChange, handleInputBlur } = useSpeechLine({ speech, index, lineIndex, handleEditClick })
