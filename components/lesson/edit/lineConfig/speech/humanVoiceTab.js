        ...
        <Row>
          <Col md={11}>
            <Row>
              <Col md={11}>
                <Container height='30'>
                  <InputRange key={audioCurrent} color='var(--soft-white)' defaultValue={audioCurrent} min='0' max={audioMax} step='0.01' disabled={isRecording} onInput={handleSeek} onChange={handleSeek} />
