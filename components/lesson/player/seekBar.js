    ...
    <Container invisible={invisible}>
      <ContainerSpacer left='15' right='15'>
        <ColorFilter filter='drop-shadow(2px 2px 2px var(--dark-purple))'>
          <Flex>
            <InputRange color='var(--soft-white)' value={value} min='0' max={parseFloat((maxTime).toFixed(2))} step='0.01' onChange={onSeekChange} onTouchStart={onSeekChange} onMouseUp={onSeekUp} onTouchEnd={onSeekUp} />
          </Flex>
        </ColorFilter>
      </ContainerSpacer>
    </Container>
