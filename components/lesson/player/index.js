...
export default function LessonPlayer(props) {
  const { isPreparing, durationSec, backgroundImageURL, avatars, graphics, drawings, speeches, drawingRef, startDrawing, inDrawing, endDrawing, ...controllerProps } = props
