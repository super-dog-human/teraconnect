    ...
    <>
      ...
      <Layout>
        <div>
          ...
          <div>第12条（準拠法・裁判管轄）</div>
          本規約の解釈にあたっては、日本法を準拠法とします。
          <br />
          本サービスに関して紛争が生じた場合には、水戸地方裁判所を専属的合意管轄裁判所とします。
          <br />
        </div>
      </Layout>
    </>
