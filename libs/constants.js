...
export const SYNTHESIS_JAPANESE_VOICE_NAMES = [
...
export const SYNTHESIS_ENGLISH_VOICE_NAMES = [
...
export const SUPPORTED_IMAGE_FILES = 'image/jpeg,image/png,image/gif,image/webp'