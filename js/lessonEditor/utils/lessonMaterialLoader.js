...
export async function loadAvatarElement(
    ...
    const avatar = new LessonAvatar(lessonID)
...
export async function fetchAndMergeGraphicToTimeline(graphics, timelines) {
...
export function mergeVoiceTextToTimeline(timelines, voiceTexts) {
    const voiceTextById = {}
...
export async function fetchVoiceURLsToTimelines(lessonID, timelines) {
